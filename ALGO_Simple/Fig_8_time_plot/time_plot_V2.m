...
% Date: June 2026
% Author: Laure WOLFF
% Please note that this function takes a long time to compile, 
% especially if you're not using a mex file. (useMex line 21)
% You can also change neuron_counts (line 23) to see only the begining of
% the figure.
