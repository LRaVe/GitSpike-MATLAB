    ...
    for s = stimuli
        ...
        for r = repetitions
            ...
            if showPooling
                ...
                pooledNC = ...
                    pool_neurons(spikes,nonCoding,s,r);
    
                for k = 1:length(pooledNC)
    
                    line([pooledNC(k) pooledNC(k)], ...
                         [yNC-0.4 yNC+0.4], ...
                         'Color',[0 0 1], ...
                         'LineWidth',1.5);
                ...
                pooledAll = ...
                    pool_neurons(spikes,1:N,s,r);
    
                for k = 1:length(pooledAll)
    
                    line([pooledAll(k) pooledAll(k)], ...
                         [yAll-0.4 yAll+0.4], ...
                         'Color','k', ...
                         'LineWidth',1.5);
