...
In the ALGO_Simple folder, a file has a “mex” version for faster performance. To enable it, navigate to the SPIKE_distance folder and then use the command line “mex SPIKE_dist_2x2_mex.cpp” in the console.
